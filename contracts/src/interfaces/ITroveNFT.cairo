...
//IAddressesRegistry is import it, define a variable in thre struct AddressVars and return it from function  function troveNFT() external view returns (ITroveNFT);

//ITroveManager is import it, return it from function  function troveNFT() external view returns (ITroveNFT);
